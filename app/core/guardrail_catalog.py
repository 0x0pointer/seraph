...
GUARDRAIL_CATALOG: list[dict] = [
    ...
    {"name": "Code Detector (Input)",      "scanner_type": "Code",              "direction": "input",
     "is_active": True, "on_fail_action": "block",   "params": {"languages": ["Python", "JavaScript", "Java", "C", "C++", "Go", "Rust", "PHP", "Ruby", "PowerShell"], "is_blocked": True, "threshold": 0.5}, "order": 10},
    ...
    {"name": "Code Detector (Output)",     "scanner_type": "Code",              "direction": "output",
     "is_active": True, "on_fail_action": "block",   "params": {"languages": ["Python", "JavaScript", "Java", "C", "C++", "Go", "Rust", "PHP", "Ruby", "PowerShell"], "is_blocked": True, "threshold": 0.5}, "order": 8},
    ...
    {"name": "Factual Consistency",        "scanner_type": "FactualConsistency","direction": "output",
     "is_active": True, "on_fail_action": "reask",   "params": {"minimum_score": 0.5}, "order": 11},
