  ...
  if (!token || loadError) {
    return (
      <div className="text-center space-y-4">
        ...
        <Link href="/login" className="text-xs font-mono" style={{ color: "#14B8A6" }}>← Go to login</Link>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-xs text-slate-600">
        ...
        <Link href="/login" className="underline" style={{ color: "#14B8A6" }}>Sign in</Link>
      </p>
    </div>
  );
}
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-white font-semibold text-sm">Project 73</span>
          </div>
