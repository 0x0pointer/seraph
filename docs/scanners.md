# Seraph — Scanner Reference

Seraph wraps the [llm-guard](https://github.com/protectai/llm-guard) library. Below is the complete reference for all 39 scanners available in the platform and their configuration parameters.
